...
const classSchedule = require('../src/model/classSchedule.json')
const weekImages = require('../src/model/photo.json')
...
for (let s of classSchedule) {
    ...
    fsex.writeFileSync(path.resolve(__dirname, `../src/schedule/${name}.ts`), outtemplate)
    index++;
}
